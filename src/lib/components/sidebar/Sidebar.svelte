<script lang="ts">
  ...
  const isConnectionsActive = $derived(page.url.pathname.startsWith('/settings/connections'));
...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    {#if storageMode === 'api'}
      ...
      <a href="/settings/connections" class="nav-item" class:active={isConnectionsActive}>
        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
